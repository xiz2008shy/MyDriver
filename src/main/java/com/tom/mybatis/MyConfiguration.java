...
public class MyConfiguration extends Configuration{
    ...
    protected final MyMapperRegistry myMapperRegistry = new MyMapperRegistry(this);
    protected final InterceptorChain interceptorChain = new InterceptorChain();
    protected final TypeHandlerRegistry typeHandlerRegistry = new TypeHandlerRegistry(this);
    protected final TypeAliasRegistry typeAliasRegistry = new TypeAliasRegistry();
    protected final LanguageDriverRegistry languageRegistry = new LanguageDriverRegistry();

    protected final Map<String, MappedStatement> mappedStatements = new MyConfiguration.StrictMap<MappedStatement>(
            "Mapped Statements collection")
            .conflictMessageProducer((savedValue, targetValue) -> ". please check " + savedValue.getResource() + " and "
                    + targetValue.getResource());
    protected final Map<String, Cache> caches = new MyConfiguration.StrictMap<>("Caches collection");
    protected final Map<String, ResultMap> resultMaps = new MyConfiguration.StrictMap<>("Result Maps collection");
    protected final Map<String, ParameterMap> parameterMaps = new MyConfiguration.StrictMap<>("Parameter Maps collection");
    protected final Map<String, KeyGenerator> keyGenerators = new MyConfiguration.StrictMap<>("Key Generators collection");

    protected final Set<String> loadedResources = new HashSet<>();
    protected final Map<String, XNode> sqlFragments = new MyConfiguration.StrictMap<>("XML fragments parsed from previous mappers");
    ...
    public void addMappers(String packageName, Class<?> superType) {
        myMapperRegistry.addMappers(packageName, superType);
    }

    public void addMappers(String packageName) {
        myMapperRegistry.addMappers(packageName);
    }

    public <T> void addMapper(Class<T> type) {
        myMapperRegistry.addMapper(type);
    }

    public <T> T getMapper(Class<T> type, SqlSession sqlSession) {
        return myMapperRegistry.getMapper(type, sqlSession);
    }

    public boolean hasMapper(Class<?> type) {
        return myMapperRegistry.hasMapper(type);
    }
    ...
    protected static class StrictMap<V> extends ConcurrentHashMap<String, V> {
         ...
         * @since 3.5.0
         */
        public MyConfiguration.StrictMap<V> conflictMessageProducer(BiFunction<V, V, String> conflictMessageProducer) {
        ...
        public V put(String key, V value) {
            ...
            if (key.contains(".")) {
                ...
                if (super.get(shortKey) == null) {
                    ...
                    super.put(shortKey, (V) new MyConfiguration.StrictMap.Ambiguity(shortKey));
                }
            }
        ...
        public V get(Object key) {
            ...
            if (value instanceof MyConfiguration.StrictMap.Ambiguity) {
                throw new IllegalArgumentException(((MyConfiguration.StrictMap.Ambiguity) value).getSubject() + " is ambiguous in " + name
